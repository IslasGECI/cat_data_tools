...
def filter_between_dates(dataframe, initial_date, final_date, date_column_name):
    is_date_after_initial_date = dataframe[date_column_name] >= initial_date
    is_date_before_final_date = dataframe[date_column_name] <= final_date
    return dataframe.loc[is_date_after_initial_date & is_date_before_final_date]
